...
function sortCarInventory(inventory) {
  /* code here */
  return inventory.sort(function(a,b){return(a.car_model > b.car_modle?1:(a.car_model < b.car_model)? -1:0)})
...
/*
  inventory[i].car_make === 'Audi' || inventory[i].car_make === 'Mercedes-Benz' || nventory[i].car_make === 'Volkswagen' || nventory[i].car_make === 'BMW'?germanCars.push(inventory[i].car_make);
*/
